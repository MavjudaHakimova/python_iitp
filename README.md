...
Python 3.8+
Учетная запись для API Mistral (получите ключ на mistral.ai).
Доступ к Weaviate (локально или облачно).
Для локального развертывания LLM: мощный GPU (для больших моделей).
